...
COPY --from=BUILD /app/target/spring-petclinic-vaadin-flow-3.0.0-SNAPSHOT.jar /app/
WORKDIR /app/
EXPOSE 8080
ENTRYPOINT java -jar spring-petclinic-vaadin-flow-3.0.0-SNAPSHOT.jar 8080
